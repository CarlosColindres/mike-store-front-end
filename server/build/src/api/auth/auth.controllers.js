        ...
        switch (_a.label) {
            case 0:
                newUser = {
                    ...
                    password: auth_helpers_1.hashPassword(req.body.password),
                };
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_model_1.default.createUser(newUser)];
            case 2:
                user = _a.sent();
                if (user) {
                    res.status(201).json({
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_model_1.default.findUserByUsername(userName)];
            case 2:
                user = _b.sent();
                if (user && bcryptjs_1.default.compareSync(password, user.password)) {
                    token = auth_helpers_1.makeToken(user);
                    res.status(200).json({
                        token: token,
                        _id: user._id,
