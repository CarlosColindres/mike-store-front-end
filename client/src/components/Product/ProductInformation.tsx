...
import type {
  ReduxStoreInterface,
  ProductCart,
} from '../../interfaces/reduxStoreInterfaces'
...
const ProductInformation: FunctionComponent<Product> = ({
  ...
  const { cart, cartLength } = useSelector(
    (state: ReduxStoreInterface) => state.cart
  )
  ...
  return (
    <div className='md:w-5/12'>
      ...
      <button
        onClick={() => addToLocalStorage(cart, cartLength, newItem)}
